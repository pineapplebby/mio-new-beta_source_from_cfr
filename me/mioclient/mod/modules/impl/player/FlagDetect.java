...
import me.mioclient.api.util.entity.PlayerData;
    ...
    public void onPacket(PacketEvent event) {
        if (!FlagDetect.fullNullCheck() && FlagDetect.spawnCheck() && !Clip.INSTANCE.isOn() && event.getPacket() instanceof SPacketPlayerPosLook) {
            ...
            if (this.chams.getValue().booleanValue()) {
                this.player = new PlayerData(EntityUtil.copyPlayer((EntityPlayer)FlagDetect.mc.player), System.currentTimeMillis(), FlagDetect.mc.player.posX, FlagDetect.mc.player.posY, FlagDetect.mc.player.posZ, FlagDetect.mc.player.getSkinType().equals("slim"));
            }
        }
    }
