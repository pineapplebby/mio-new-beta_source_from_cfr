...
extends Module {
    ...
    private final Setting<Integer> radius = this.add(new Setting<Integer>("Radius", 80, 10, 200, v -> this.mode.getValue().equals((Object)Mode.ARROW)));
    private final Setting<Float> size = this.add(new Setting<Float>("Size", Float.valueOf(7.5f), Float.valueOf(5.0f), Float.valueOf(25.0f), v -> this.mode.getValue().equals((Object)Mode.ARROW)));
    private final Setting<Boolean> outline = this.add(new Setting<Boolean>("Outline", true, v -> this.mode.getValue().equals((Object)Mode.ARROW)));
    ...
    public void onRender2D(Render2DEvent event) {
        if (this.mode.getValue().equals((Object)Mode.ARROW)) {
    ...
    public void onRender3D(Render3DEvent event) {
        if (this.mode.getValue().equals((Object)Mode.TRACER)) {
