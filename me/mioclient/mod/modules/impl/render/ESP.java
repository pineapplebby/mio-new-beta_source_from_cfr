...
extends Module {
    ...
    public void onRender3D(Render3DEvent event) {
        ...
        for (EntityPlayer player : ESP.mc.world.playerEntities) {
            ...
            if (player.isSpectator() || player.isRiding() || player == ESP.mc.player || BlockUtil.getBlock(feetPos) == Blocks.AIR || BlockUtil.canReplace(feetPos) || !(ESP.mc.player.getDistanceSq(feetPos) <= 200.0)) continue;
