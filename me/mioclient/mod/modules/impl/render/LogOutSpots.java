...
extends Module {
    ...
    implements Wrapper {
        ...
        public LogOutSpot(EntityPlayer player) {
            ...
            this.model = new StaticModelPlayer(EntityUtil.copyPlayer(player), player instanceof AbstractClientPlayer && ((AbstractClientPlayer)player).getSkinType().equals("slim"), 0.0f);
