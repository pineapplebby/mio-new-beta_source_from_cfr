...
public class Setting<T> {
    ...
    public Setting(String name, T defaultValue, T minValue, T maxValue, Predicate<T> visibility) {
        this.name = name;
    ...
    public void setValue(T value) {
        ...
        if (this.restriction) {
            if (((Number)this.minValue).floatValue() > ((Number)value).floatValue()) {
                this.setPlannedValue(this.minValue);
            }
            if (((Number)this.maxValue).floatValue() < ((Number)value).floatValue()) {
    ...
    public Setting<T> injectBoolean(boolean value) {
